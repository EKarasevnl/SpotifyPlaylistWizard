...
def create_playlist():
    ...
    user_headers = {"Authorization": f"Bearer {access_token}", "Content-Type": "application/json"}

    data = {"name": "Test Playlist", "description": "New playlist description", "public": False}
